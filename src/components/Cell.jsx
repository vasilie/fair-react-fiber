...
const Cell = ({positionX, radius, gridSizeX, gridSizeY, angle, sectorId, sectorColor}) => {
  ...
  const childPosition = getPointOnACircle(angle + positionX * angle - angle / 2, radius + 1, 0.03);
  const childRotation = [0, angle + positionX * angle - angle / 2 - toRadians(90), 0];
